...
export default function Tire_service() {
  return (
    <>
              ...
              <div className="col-12 pt-4">
                <div className="row">
                  <div className="col-12 text-left">
                    <h1 className="page_title">Car Scanning Diagnostics</h1>
                    <p>
                      <span>
                      ...
                      <span>Car Scanning Diagnostics</span>
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="row">
                    <div className="col-12">
                      <div className="image_wrapper">
                        <picture>
                          <source
                            srcset="/assets/front/uploads/services/car-diagnostic-007.jpg"
                            type="image/webp"
                          />
                          <source
                            srcset="/assets/front/uploads/services/car-diagnostic-007.jpg"
                          ...
                          <img
                            ...
                            src="/assets/front/uploads/services/car-diagnostic-007.jpg"
                          />
                        </picture>
                      </div>
                    </div>
